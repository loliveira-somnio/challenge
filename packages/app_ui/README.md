...
App UI package containing a general design system.
...
```
2) In `app_icons_light.dart` add the icon with its color respectively of the theme. 
...
3) In `app_icons_dark.dart` add the icon with its color respectively of the theme. 
