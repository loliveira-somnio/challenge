...
void main() {
  group('MeetupRepositoryImpl', () {
    ...
    late MeetupRepositoryImpl meetupRepository;
    ...
    setUp(() {
      ...
      meetupRepository = MeetupRepositoryImpl(mockMeetupService);
    });

    group('constructor', () {
      test('creates instance with MeetupService dependency', () {
        expect(meetupRepository, isA<MeetupRepositoryImpl>());
        expect(meetupRepository, isA<MeetupRepository>());
      });
    });
    ...
    group('getPreviousMeetups', () {
      test('delegates to MeetupService and returns list of meetups', () async {
        ...
        // Assert
        expect(result, isA<List<MeetupData>>());
